                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                        <div class="fs-4 text-dark fw-bolder">Filtre Bölümü</div>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Separator-->
                                    ...
                                    <div class="px-7 py-5">
                                        <div class="mb-10">
                                            <!--begin::Label-->
                                            <label class="form-label fs-5 fw-bold mb-3">Seçenekler:</label>
                                            <!--end::Label-->
                                            <!--begin::Options-->
                                            <div class="d-flex flex-column flex-wrap fw-bold" data-kt-customer-table-filter="payment_type">
                                                <!--begin::Option-->
                                                <form action="" id="sliderchoiselist" >
                                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-3 me-5">
                                                        <input class="form-check-input" type="radio" name="choise" value="tr" @if(request()->get('choise') == "tr") checked="checked" @endif  />
                                                        <span class="form-check-label text-gray-600">Türkçe İçerikler</span>
                                                    </label>
                                                    <!--end::Option-->
                                                    <!--begin::Option-->
                                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-3 me-5">
                                                        <input class="form-check-input" type="radio" name="choise" value="en" @if(request()->get('choise') == "en") checked="checked" @endif />
                                                        <span class="form-check-label text-gray-600">İngilizce içerikler</span>
                                                    </label>
                                                    <!--end::Option-->
                                                    <!--begin::Option-->
                                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-3">
                                                        <input class="form-check-input" type="radio" name="choise" value="new" @if(request()->get('choise') == "new") checked="checked" @endif />
                                                        <span class="form-check-label text-gray-600">Yeni İçerikler</span>
                                                    </label>
                                                    <!--end::Option-->
                                                    <!--begin::Option-->
                                                    <label class="form-check form-check-sm form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="radio" name="choise" value="old" @if(request()->get('choise') == "old") checked="checked" @endif />
                                                        <span class="form-check-label text-gray-600">Eski İçerikler</span>
                                                    </label>
                                                </form>
                                                <!--end::Option-->
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <button type="button" id="sliderchoiseBtn" class="btn btn-primary" data-kt-menu-dismiss="true" data-kt-customer-table-filter="filter">Arama</button>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
                                    <!--end::Content-->
                                ...
                                <a href="{{ route('admin.slider.create') }}">
                                    <button type="button"  class="btn btn-primary">Slider Ekle</button>
                                </a>
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                            ...
                            @foreach($data['SliderData'] as $item)
                                <tr id="{{ $item->lang_key }}" style="cursor: move">
                                    <!--begin::Checkbox-->
...
@section('js')
    ...
    <script>
        $('#sliderchoiseBtn').on('click',function(){
            $('#sliderchoiselist').submit();
        })
    </script>
