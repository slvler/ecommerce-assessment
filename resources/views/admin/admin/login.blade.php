            ...
            <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                ...
                <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                    ...
                    <a href="../../demo2/dist/index.html" class="py-9 mb-5">
                        <img alt="Logo" src="{{ asset('back/assets/media/logos/logo-2.svg') }}" class="h-60px" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Title-->
                ...
                <!--end::Content-->
                <!--begin::Illustration-->
                <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url({{ asset('back/assets/media/illustrations/sigma-1/13.png') }})"></div>
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
        </div>
        ...
        <div class="d-flex flex-column flex-lg-row-fluid py-10">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="form w-100" method="post" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('admin.check') }}">
                            @csrf
                            @method('POST')
                        <!--begin::Heading-->
